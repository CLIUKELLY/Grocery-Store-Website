        ...
        <section class="main">
            ...
            <div class="center-left">
                <div class="row">
                    <div class="column">
                        <div class="card">
                            <img src="Vegetable_Carrot.jpeg" alt="Jane" style="width:100%" >
                        </div>
                        <br>
                    </div>
                    <div class="column">
                        <div class="productName">Carrot</div>
                        <div class="price">
							<div class="price-text">$<span class="productPrice">1.59</span></div>/ <b>EA</b></div><br><br>
                        ...
                        <div class="productDetail">
                            ...
                            <p class="description">Freshest carrots grew by Quebec local farms.</p>
                        </div>
                    </div>
                </div>
...
<script src="js/P3_Vege_Carrot.js"></script>
</body>
</html>